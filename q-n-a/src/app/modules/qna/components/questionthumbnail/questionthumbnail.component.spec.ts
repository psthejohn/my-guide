...
import { QuestionthumbnailComponent } from './questionthumbnail.component';
...
describe('QuestionthumbnailComponent', () => {
  ...
  it('should contain input boxes for add comment and submit button',()=>{
    let questionNew= fixture.debugElement.query(By.css('.question-input'));
    let sumbitButton = fixture.debugElement.query(By.css('.submit-button'));
    
    let questionInput = questionNew.nativeElement;
