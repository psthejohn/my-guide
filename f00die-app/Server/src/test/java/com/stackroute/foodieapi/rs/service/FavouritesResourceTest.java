...
@PrepareForTest(FavouritesResourceTest.class)
public class FavouritesResourceTest {
	...
	public final void testGetAllCities() {
		...
		PowerMockito.when(restTemplate.exchange(theURL, HttpMethod.GET, entity, Cities.class)).thenReturn(response);
