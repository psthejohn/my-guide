...
@PrepareForTest(CuisinesResourceTest.class)
public class CuisinesResourceTest {
	...
	@Test
	public final void testGetAllCuisines() {
		PowerMockito.when(headers.getContentType()).thenReturn(MediaType.APPLICATION_JSON);
		HttpEntity<String> entity = new HttpEntity<String>("parameters", headers);
		ResponseEntity<CuisinesModel> response = null;

		PowerMockito.when(restTemplate.exchange(theURL, HttpMethod.GET, entity, CuisinesModel.class))
				.thenReturn(response);
